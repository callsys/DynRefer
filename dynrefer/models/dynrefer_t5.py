...
@registry.register_model("dynrefer_t5")
class DynReferT5(Blip2T5):
    def __init__(self, *args, **kwargs):
        ...
        base_kwargs_keys = ["vit_model", "img_size", "drop_path_rate", "use_grad_checkpoint", "vit_precision",
                            "freeze_vit", "num_query_token", "t5_model", "prompt", "max_txt_len",
                            "apply_lemmatizer"]
        ...
        names = ["cvem", "cem", "tag", "attr", "Qformer", "t5_proj"]
